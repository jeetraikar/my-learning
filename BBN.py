import bayespy as bp#BayesPy provides tools for Bayesian inference with Python.
...
p_age = bp.nodes.Dirichlet(1.0*np.ones(5))#used to classify text in a document to a particular topic.
#print(p_age)
age = bp.nodes.Categorical(p_age, plates=(N,))#a sequence of unique values and no missing values
#print(age)
age.observe(data[:,0])
#print("age",age)
